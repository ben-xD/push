...
class UNNotificationSettings {
  ...
  Object encode() {
    final Map<Object?, Object?> pigeonMap = <Object?, Object?>{};
    pigeonMap['authorizationStatus'] = authorizationStatus?.index;
    pigeonMap['soundSetting'] = soundSetting?.index;
    pigeonMap['badgeSetting'] = badgeSetting?.index;
    pigeonMap['alertSetting'] = alertSetting?.index;
    pigeonMap['notificationCenterSetting'] = notificationCenterSetting?.index;
    pigeonMap['lockScreenSetting'] = lockScreenSetting?.index;
    pigeonMap['carPlaySetting'] = carPlaySetting?.index;
    pigeonMap['alertStyle'] = alertStyle?.index;
    pigeonMap['showPreviewsSetting'] = showPreviewsSetting?.index;
    pigeonMap['criticalAlertSetting'] = criticalAlertSetting?.index;
    pigeonMap['providesAppNotificationSettings'] = providesAppNotificationSettings;
    pigeonMap['announcementSetting'] = announcementSetting?.index;
    return pigeonMap;
  }
