...
void SetUpPUPushHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<PUPushHostApi> *api, NSString *messageChannelSuffix) {
  ...
  /// See [PushFlutterApi.onNotificationTap] to understand why a RemoteMessage is not provided here.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushHostApi.getNotificationTapWhichLaunchedTerminatedApp", messageChannelSuffix]
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushHostApi.getToken", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:PUGetPushApiCodec()];
    if (api) {
  ...
  ///  will get an error: `Requested entity was not found.`
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushHostApi.deleteToken", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:PUGetPushApiCodec()];
    if (api) {
  ...
  /// Warning: on IOS simulators, no notifications will be delivered when calling unregisterForRemoteNotifications and then `registerForRemoteNotifications`
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushHostApi.unregisterForRemoteNotifications", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:PUGetPushApiCodec()];
    if (api) {
  ...
  /// the same token as before you called [PushHostApi.unregisterForRemoteNotifications].
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushHostApi.registerForRemoteNotifications", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:PUGetPushApiCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushHostApi.backgroundFlutterApplicationReady", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:PUGetPushApiCodec()];
    if (api) {
  ...
  /// Returns true if permission was granted.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushHostApi.requestPermission", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:PUGetPushApiCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushHostApi.getNotificationSettings", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:PUGetPushApiCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushHostApi.areNotificationsEnabled", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:PUGetPushApiCodec()];
    if (api) {
...
- (void)onMessageMessage:(PURemoteMessage *)arg_message completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushFlutterApi.onMessage", _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
...
- (void)onBackgroundMessageMessage:(PURemoteMessage *)arg_message completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushFlutterApi.onBackgroundMessage", _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:channelName
      binaryMessenger:self.binaryMessenger
...
- (void)onNotificationTapData:(NSDictionary<NSString *, id> *)arg_data completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushFlutterApi.onNotificationTap", _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:channelName
      binaryMessenger:self.binaryMessenger
...
- (void)onNewTokenToken:(NSString *)arg_token completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushFlutterApi.onNewToken", _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:channelName
      binaryMessenger:self.binaryMessenger
...
- (void)onOpenNotificationSettingsWithCompletion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushFlutterApi.onOpenNotificationSettings", _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:channelName
      binaryMessenger:self.binaryMessenger
