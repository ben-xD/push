...
void SetUpPUPushHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<PUPushHostApi> *api, NSString *messageChannelSuffix) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushHostApi.onListenToOnNewToken", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:PUPushHostApiGetCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.push_platform_interface.PushHostApi.onCancelToOnNewToken", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:PUPushHostApiGetCodec()];
    if (api) {
