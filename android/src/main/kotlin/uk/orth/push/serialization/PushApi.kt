 ...
 */
enum class UNAuthorizationStatus(
    val raw: Int,
) {
    NOT_DETERMINED(0),
    DENIED(1),
    ...
    companion object {
        fun ofRaw(raw: Int): UNAuthorizationStatus? = values().firstOrNull { it.raw == raw }
    }
}
...
enum class UNAlertStyle(
    ...
    companion object {
        fun ofRaw(raw: Int): UNAlertStyle? = values().firstOrNull { it.raw == raw }
    }
}
 ...
 */
enum class UNNotificationSetting(
    val raw: Int,
) {
    NOT_SUPPORTED(0),
    DISABLED(1),
    ...
    companion object {
        fun ofRaw(raw: Int): UNNotificationSetting? = values().firstOrNull { it.raw == raw }
    }
}
 ...
 */
enum class UNShowPreviewsSetting(
    val raw: Int,
) {
    ALWAYS(0),
    ...
    companion object {
        fun ofRaw(raw: Int): UNShowPreviewsSetting? = values().firstOrNull { it.raw == raw }
    }
}
        ...
        fun setUp(
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.push.PushHostApi.getNotificationTapWhichLaunchedTerminatedApp$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.push.PushHostApi.getToken$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.push.PushHostApi.deleteToken$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.push.PushHostApi.registerForRemoteNotifications$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.push.PushHostApi.unregisterForRemoteNotifications$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.push.PushHostApi.backgroundFlutterApplicationReady$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.push.PushHostApi.requestPermission$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { message, reply ->
                        ...
                        api.requestPermission(
                            ...
                            criticalAlertArg,
                            provisionalArg,
                            providesAppNotificationSettingsArg,
                            announcementArg,
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.push.PushHostApi.getNotificationSettings$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.push.PushHostApi.areNotificationsEnabled$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
